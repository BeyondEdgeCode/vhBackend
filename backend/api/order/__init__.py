...
from .routes import create, get_by_user, cancel_by_user, \
    cancel_by_admin, change_state, get_by_admin, get_one_by_admin
...
order.add_url_rule('/aget_one', 'get_one_by_admin', get_one_by_admin, methods=['GET'])
